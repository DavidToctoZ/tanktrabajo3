...
namespace ULTanksZombies.Zombies
{
    public class ZombieController : MonoBehaviour
    {
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            {
                Destroy(gameObject);
                GameManager.Instance.numKillsZombie = GameManager.Instance.numKillsZombie + 1;
                GameManager.Instance.totalKills = GameManager.Instance.totalKills + 1;
                GameManager.Instance.cantZombies = GameManager.Instance.cantZombies - 1;
            }
        }
    }
}

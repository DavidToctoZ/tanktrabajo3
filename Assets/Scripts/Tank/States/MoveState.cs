...
namespace ULTanksZombies.Tank
{
    public class MoveState : TankState
    {
        ...
        private float fireRateBig;
        //private Vector3 mousePosition;
        private bool shoot = false;
        private bool shootBig = false;
        private float countdown = 0f;
        private float countdownBig = 0f;
        public MoveState(TankController controller, TankStateMachine fsm) : base(controller, fsm)
        {
            ...
            fireRateBig = controller.fireRateBig;
        }
        ...
        public override void OnHandleInput()
        {
            ...
            if (Input.GetMouseButtonDown(1) && countdownBig <= 0f)
            {
                shootBig = true;
                countdownBig = 1f / fireRateBig;
            }
            countdown -= Time.deltaTime;
            countdownBig -= Time.deltaTime;
